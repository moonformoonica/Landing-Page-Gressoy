...
export default function WelcomeGate({ locked, onEnter }) {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="animate-logo-halo pointer-events-none absolute left-1/2 top-1/2 h-[26rem] w-[26rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/60 blur-3xl sm:h-[34rem] sm:w-[34rem]"
      />
