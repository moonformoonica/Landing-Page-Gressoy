...
export function GofoodIcon({ className = 'h-5 w-5' }) {
  return <BrandBadge className={className} bg="#00AA13" path={GOJEK_PATH} />
}

export function GrabfoodIcon({ className = 'h-5 w-5' }) {
  return <BrandBadge className={className} bg="#00B14F" path={GRAB_PATH} />
}

export function ShopeeFoodIcon({ className = 'h-5 w-5' }) {
  return <BrandBadge className={className} bg="#EE4D2D" path={SHOPEE_PATH} />
}
