import gofoodLogo from '../assets/logos/gofood.png'
import grabfoodLogo from '../assets/logos/grabfood.png'
import shopeefoodLogo from '../assets/logos/shopeefood.png'
...
// Badge lingkaran putih berisi file logo resmi platform (gofood.png,
// grabfood.png, shopeefood.png) apa adanya, supaya akurat 1:1 dengan aslinya
// (bukan gambar ulang manual) dan tetap kebaca di background warna apa pun.
function PlatformBadge({ className, src, alt }) {
  return (
    <span
      className={`${className} grid shrink-0 place-items-center overflow-hidden rounded-full bg-white p-1`}
    >
...
export function GofoodIcon({ className = 'h-5 w-5' }) {
  return <PlatformBadge className={className} src={gofoodLogo} alt="GoFood" />
}

export function GrabfoodIcon({ className = 'h-5 w-5' }) {
  return <PlatformBadge className={className} src={grabfoodLogo} alt="GrabFood" />
}

export function ShopeeFoodIcon({ className = 'h-5 w-5' }) {
  return <PlatformBadge className={className} src={shopeefoodLogo} alt="ShopeeFood" />
}
